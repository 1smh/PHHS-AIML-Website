...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>Contact - PHHS AI/ML Club</title>
        <meta name="description" content="Get in touch with the PHHS AI/ML Club. Have questions, suggestions, or want to collaborate? We'd love to hear from you." />
      </Head>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <Textarea
                        ...
                        required
                        className="min-h-[120px] bg-white/70 border-white/50 focus:border-blue-400 focus:ring-blue-400"
                      />
                    </div>
                    <Button 
                      type="submit"
