        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-400 to-purple-400 rounded-lg blur opacity-0 group-hover:opacity-50 transition duration-500" />
                <Card className="relative bg-white/80 backdrop-blur-sm p-6 rounded-lg border shadow-md hover:shadow-lg transition-shadow h-full">
